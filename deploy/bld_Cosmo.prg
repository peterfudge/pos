...
EXE_FILE		  =		  	"Cosmo"
DCOM_ProgId       =			"Cosmo.CosmoServer"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Cosmo/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Cosmo/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Cosmo/wc.wc?wwmaint~FileUpload"
